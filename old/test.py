...
df = pd.read_excel('big_business_db.xlsx')

pre_total_list = df['Название компании'].tolist()
...
list_to_compare = [word.lower() for word in total_list]
